...
public class InventoryItemFile {
    ...
    public InventoryItemFile(String filename) throws FileNotFoundException
    {
    ...
    /**
     The writeInventoryItem method writes the contents of an InventoryItem object
    ...
    public void writeInventoryItem(InventoryItem item) throws IOException
    {
        ...
        else
        {
            ...
            // Write enough spaces to pad it out to 20 characters.
            ...
            throws IOException
    {
        ...
        //String desc = String.valueOf(charArray);	//alternate code
        ...
        // Create an InventoryItem object and initialize it with these values.
        InventoryItem item = new InventoryItem(desc, u);
    ...
    /**
     The getByteNum method returns a record's starting byte number.
     @param recordNum The record number of the desired record.
     */
